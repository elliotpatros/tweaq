#ifndef test_externs_normalize_h
#define test_externs_normalize_h // START TEST
...
bool normalize_setup(const t_uint index, t_parameter* p)
{
    ...
    {
        case kGain:
            return setParameterName(p, "normalize to peak")
...
bool normalize_process(char** debug, const t_uint argc, const char* argv[])
{
    setString(debug, "got here");
