#ifndef test_externs_strip_silence_at_start_h
#define test_externs_strip_silence_at_start_h
...
bool strip_silence_at_start_setup(const t_uint index, t_parameter& p)
{
    ...
    {
        case kThreshold:
            return setParameterName(p, "threshold")
            && setParameterLabels(p, 2, "dB.", "gain")
            && setParameterDefault(p, -60.0);
        default:
            return false;
...
bool strip_silence_at_start_process(t_int argc, const char* argv[])
{
